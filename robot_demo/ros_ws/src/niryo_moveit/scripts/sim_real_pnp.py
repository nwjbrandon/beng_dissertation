...
from niryo_one_msgs.msg import (RobotMoveAction, RobotMoveGoal, ToolCommand,
                                TrajectoryPlan)
...
def plan_pick_and_place(req):
    ...
    pick_pose.position.z -= (
        PICK_PLACE_HEIGHT_OFFSET  # Static value coming from Unity, TODO: pass along with request
    )
