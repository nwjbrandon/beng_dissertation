...
class Decoder(nn.Module):
    def __init__(self, out_channels):
        ...
        self.conv7 = UpConv(in_channels=264, out_channels=out_channels)
        self.conv8 = UpConv(in_channels=136, out_channels=out_channels)
        self.conv9 = UpConv(in_channels=72, out_channels=out_channels)
        self.conv10 = OutConv(in_channels=8, out_channels=out_channels)
