...
class Regressor3d(nn.Module):
    def __init__(self, config):
        ...
        self.conv13 = DownConv(64, 21)
        self.conv14 = BasicBlock(149, 149)
        self.conv15 = DownConv(149, 42)
        self.conv16 = BasicBlock(298, 298)
        self.conv17 = DownConv(298, 63)
        self.conv18 = BasicBlock(575, 575)
        self.conv19 = DownConv(575, 63)

        self.flat = nn.Flatten()
        self.fc = nn.Linear(1008, self.out_channels * 3)
